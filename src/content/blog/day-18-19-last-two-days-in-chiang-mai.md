---
title: "Day 18 & 19: Last Two Days in Chiang Mai"
...
Morning of the 30th we decided today would be a museum day! We first got breakfast at a small cafe called bloomin moon and i got a mozzarella and spinach toast. Twas delicious!

![](../../assets/img_2812.jpeg)

From here we headed to the Chiang Mai Cultural Museum! The museum focused heavily on the history of just Chiang Mai, and primarily the kingdom of Lanna and its evolution overtime, all the way through conception through being annexed into the Kingdom of Siam(what eventually becomes modern Thailand).
...
# Sharyq and Benji go to more Markets because we have an addiction
...
We landed in Bangkok at at 6:30pm and initially just due to distance and energy, we were just going to Grab, but Grab at failed us for once, stated there was no available drivers, so we decided to take the train system. It was about an hour and a half to the hotel, which was not bad given it was an hour drive. We had to take 4 different trains, first the Red line, which was 20 minutes till we were in the center of the city, from here it was an easy transfer to the blue line which was right by and we just took for 2 stops before we had to get on the next line that didn’t allow for visa tap to enter, so we had to go get a rabbit card(public transport card) and once we did that, and loaded it up with some cash, we got through, and then did it again for the last line. Overall Bangkok public transport looks very nice, trains are miles cleaner than any American train, and are very modern, but after doing some reading, the trains are perceived as not always convenient, and comparably expensive given thai wages, and also the rabbit card doesnt work for every line? Regardless i liked it.
